...
{
	[TOD_Range(0f, 1f), Tooltip("Density of the clouds.")]
	public float Density = 1f;

	[TOD_Min(0f), Tooltip("Sharpness of the clouds.")]
	public float Sharpness = 3f;

	[TOD_Min(0f), Tooltip("Brightness of the clouds.")]
	public float Brightness = 1f;

	[TOD_Min(0f), Tooltip("Number of billboard clouds to instantiate at start.\nBillboard clouds are not visible in edit mode.")]
	public int Billboards;

	[TOD_Range(0f, 1f), Tooltip("Opacity of the cloud shadows.")]
